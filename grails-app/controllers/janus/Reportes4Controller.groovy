...
//        def vae = preciosService.rb_preciosVae(parametros, "")
        ...
        headers.add(new Paragraph("DGCP - COORDINACIÓN DE FIJACIÓN DE PRECIOS UNITARIOS - ANÁLISIS DE PRECIOS UNITARIOS", times10bold));
...
//        addCellTabla(tablaCoeficiente, new Paragraph(" ", times10normal), prmsHeaderHoja)
        ...
        tablaEquipos.setWidths(arregloEnteros([11,31,11,11,11,12,11]))

        addCellTabla(tablaEquipos, new Paragraph("EQUIPOS", times14bold), [border: Color.WHITE, colspan: 7, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])

        addCellTabla(tablaEquipos, new Paragraph("CÓDIGO", times8bold), celdaCabecera)
        addCellTabla(tablaEquipos, new Paragraph("DESCRIPCIÓN", times8bold), celdaCabecera)
        addCellTabla(tablaEquipos, new Paragraph("CANTIDAD", times8bold), celdaCabecera)
        addCellTabla(tablaEquipos, new Paragraph("TARIFA(\$/H)", times8bold), celdaCabecera)
        addCellTabla(tablaEquipos, new Paragraph("COSTOS(\$)", times8bold), celdaCabecera)
        ...
        res.eachWithIndex { r, i ->
            if (r["grpocdgo"] == 3) {
                ...
                addCellTabla(tablaEquipos, new Paragraph(numero(r["rbrocntd"], 5)?.toString(), times10normal), prmsFilaDerecha)
                ...
                addCellTabla(tablaEquipos, new Paragraph(numero(r["rndm"], 5)?.toString(), times10normal), prmsFilaDerecha)
        ...
        addCellTabla(tablaEquipos, new Paragraph("TOTAL", times10bold), prmsFilaDerecha)
        addCellTabla(tablaEquipos, new Paragraph(numero(totalHer, 5)?.toString(), times10bold), prmsFilaDerecha)

        addCellTabla(tablaEquipos, new Paragraph("", times14bold), [border: Color.WHITE, colspan: 7, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])

        //MANO DE OBRA
        PdfPTable tablaManoObra = new PdfPTable(7);
        tablaManoObra.setWidthPercentage(100);
        tablaManoObra.setWidths(arregloEnteros([11,31,11,11,11,12,11]))

        addCellTabla(tablaManoObra, new Paragraph("MANO DE OBRA", times14bold), [border: Color.WHITE, colspan: 7, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])

        addCellTabla(tablaManoObra, new Paragraph("CÓDIGO", times8bold), celdaCabecera)
        addCellTabla(tablaManoObra, new Paragraph("DESCRIPCIÓN", times8bold), celdaCabecera)
        addCellTabla(tablaManoObra, new Paragraph("CANTIDAD", times8bold), celdaCabecera)
        addCellTabla(tablaManoObra, new Paragraph("JORNAL(\$/H)", times8bold), celdaCabecera)
        addCellTabla(tablaManoObra, new Paragraph("COSTOS(\$)", times8bold), celdaCabecera)
        ...
        res.eachWithIndex { r, i ->
            if (r["grpocdgo"] == 2) {
                ...
                addCellTabla(tablaManoObra, new Paragraph(numero(r["rbrocntd"], 5)?.toString(), times10normal), prmsFilaDerecha)
                ...
                addCellTabla(tablaManoObra, new Paragraph(numero(r["rndm"], 5)?.toString(), times10normal), prmsFilaDerecha)
        ...
        addCellTabla(tablaManoObra, new Paragraph("TOTAL", times10bold), prmsFilaDerecha)
        addCellTabla(tablaManoObra, new Paragraph(numero(totalMan, 5)?.toString(), times10bold), prmsFilaDerecha)

        addCellTabla(tablaManoObra, new Paragraph("", times14bold), [border: Color.WHITE, colspan: 7, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])

        //MATERIALES
        PdfPTable tablaMateriales = new PdfPTable(6);
        tablaMateriales.setWidthPercentage(100);
        tablaMateriales.setWidths(arregloEnteros([8,22,6,8,8,7]))

        if(params.trans == 'no'){
            addCellTabla(tablaMateriales, new Paragraph("MATERIALES INCLUIDO TRANSPORTE", times14bold), [border: Color.WHITE, colspan: 6, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])
        }else{
            addCellTabla(tablaMateriales, new Paragraph("MATERIALES", times14bold), [border: Color.WHITE, colspan: 6, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])
        }

        addCellTabla(tablaMateriales, new Paragraph("CÓDIGO", times8bold), celdaCabecera)
        addCellTabla(tablaMateriales, new Paragraph("DESCRIPCIÓN", times8bold), celdaCabecera)
        addCellTabla(tablaMateriales, new Paragraph("UNIDAD", times8bold), celdaCabecera)
        addCellTabla(tablaMateriales, new Paragraph("CANTIDAD", times8bold), celdaCabecera)
        addCellTabla(tablaMateriales, new Paragraph("UNITARIO(\$)", times8bold), celdaCabecera)
        addCellTabla(tablaMateriales, new Paragraph("C.TOTAL(\$)", times8bold), celdaCabecera)
        ...
        addCellTabla(tablaMateriales, new Paragraph("TOTAL", times10bold), prmsFilaDerecha)
        addCellTabla(tablaMateriales, new Paragraph(numero(totalMat, 5)?.toString(), times10bold), prmsFilaDerecha)

        addCellTabla(tablaMateriales, new Paragraph("", times14bold), [border: Color.WHITE, colspan: 6, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])
...
//
//        addCellTabla(tablaMaterialesVacia, new Paragraph("CÓDIGO", times8bold), celdaCabecera)
//        addCellTabla(tablaMaterialesVacia, new Paragraph("DESCRIPCIÓN", times8bold), celdaCabecera)
//        addCellTabla(tablaMaterialesVacia, new Paragraph("UNIDAD", times8bold), celdaCabecera)
//        addCellTabla(tablaMaterialesVacia, new Paragraph("CANTIDAD", times8bold), celdaCabecera)
//        addCellTabla(tablaMaterialesVacia, new Paragraph("UNITARIO(\$)", times8bold), celdaCabecera)
//        addCellTabla(tablaMaterialesVacia, new Paragraph("C.TOTAL(\$)", times8bold), celdaCabecera)
//        addCellTabla(tablaMaterialesVacia, new Paragraph("PESO RELAT(%)", times7bold), celdaCabecera)
//        addCellTabla(tablaMaterialesVacia, new Paragraph("CPC", times8bold), celdaCabecera)
//        addCellTabla(tablaMaterialesVacia, new Paragraph("NP/EP/ND", times8bold), celdaCabecera)
...
//        addCellTabla(tablaMaterialesVacia, new Paragraph("", times14bold), [border: Color.WHITE, colspan: 12, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])
        ...
        addCellTabla(tablaTransporte, new Paragraph("TRANSPORTE", times14bold), [border: Color.WHITE, colspan: 8, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])

        addCellTabla(tablaTransporte, new Paragraph("CÓDIGO", times8bold), celdaCabecera)
        addCellTabla(tablaTransporte, new Paragraph("DESCRIPCIÓN", times8bold), celdaCabecera)
        addCellTabla(tablaTransporte, new Paragraph("UNIDAD", times8bold), celdaCabecera)
        addCellTabla(tablaTransporte, new Paragraph("PES/VOL", times8bold), celdaCabecera)
        addCellTabla(tablaTransporte, new Paragraph("CANTIDAD", times8bold), celdaCabecera)
...
//
//        addCellTabla(tablaTransporteVacia, new Paragraph("CÓDIGO", times8bold), celdaCabecera)
...
//        addCellTabla(tablaTransporteVacia, new Paragraph("PES/VOL", times8bold), celdaCabecera)
//        addCellTabla(tablaTransporteVacia, new Paragraph("CANTIDAD", times8bold), celdaCabecera)
...
//        addCellTabla(tablaTransporteVacia, new Paragraph("CPC", time8bold), celdaCabecera)
...
//        def totalRubro = total + totalHer + totalMan + totalMat
        ...
        PdfPTable tablaNota = new PdfPTable(1);
        tablaNota.setWidthPercentage(100);
        tablaNota.setWidths(arregloEnteros([100]))
        tablaNota.horizontalAlignment = Element.ALIGN_LEFT;

        addCellTabla(tablaNota, new Paragraph("Nota: Los cálculos se hacen con todos los " +
                "decimales y el resultado final se lo redondea a dos decimales", times10bold), [border: Color.WHITE, align : Element.ALIGN_LEFT, valign: Element.ALIGN_LEFT])

        addCellTabla(tablaNota, new Paragraph("", times10bold), [border: Color.WHITE, align : Element.ALIGN_LEFT, valign: Element.ALIGN_LEFT])

        PdfPTable tablaTotales = new PdfPTable(2);
        tablaTotales.setWidthPercentage(70);
        tablaTotales.setWidths(arregloEnteros([75,25]))
