...
//        reportesPdfService.addCellTb(tablaEquipos, new Paragraph("EQUIPOS", times12bold), [border: Color.WHITE, colspan: 12, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])
        reportesPdfService.addCellTb(tablaEquipos, new Paragraph("EQUIPOS", times12bold), tituloRubro)
...
//        reportesPdfService.addCellTb(tablaEquipos, new Paragraph("", times14bold), [border: Color.WHITE, colspan: 12, align : Element.ALIGN_CENTER, valign: Element.ALIGN_MIDDLE])
